        ...
        <div style="margin-top: 15px;">
            ...
            <div class="sr-favorite-item">
                ...
                <div class="sr-image-section">
                    <a href="{{ route('productView', ['product_id' => $transaction->product->id]) }}">
                        <img src="{{ asset('storage/' . $transaction->product->image_path) }}" class="sr-favorite-image" alt="product image">
                    </a>
                </div>
                
                <div class="sr-details-section">
                    <a href="{{ route('productView', ['product_id' => $transaction->product->id]) }}" class="sr-item-title"> 
                    ...
                    <p class="sr-item-price"> 
                        ฿{{ number_format($transaction->product->price, 6) }} 
                    </p>
                </div> 
            </div>
            @endforeach
